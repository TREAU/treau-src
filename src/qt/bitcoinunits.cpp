...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TREAU");
    case mBTC: return QString("mTREAU");
    case uBTC: return QString::fromUtf8("μTREAU");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TREAUs"));
    case mBTC: return QString(QObject::tr("Milli-TREAUs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TREAUs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
